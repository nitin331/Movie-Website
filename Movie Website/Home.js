...
const Home=()=>{
  ...
  const [videoURL, setVideoURL] = 
    useState("https://www.youtube.com/watch?v=fUwMWzdeXyc ");
    ...
    const searchMovies = async(e)=>{
      ...
      console.log("search");
      try {
        const url=`https://api.themoviedb.org/3/search/movie?api_key=3de0ee2b89440fd706948ae547a9e1eb&query=${query}`
    ...
    useEffect(()=>{
        fetch('https://api.themoviedb.org/3/movie/popular?api_key=3de0ee2b89440fd706948ae547a9e1eb&language=en-US&page=1')
        .then(res=>res.json())
